...
Whenever there is a new MRTK package, this repo will be updated with the latest. You can automaticly get the latest packages by adding the seed repo as your upstream and pulling from it. 
